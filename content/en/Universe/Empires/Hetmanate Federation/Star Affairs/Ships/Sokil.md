...
title: "Sokil"
lang: "en"
translationKey: "universe/empires/hetmanate-federation/star-affairs/ships/sokil"
translations:
  uk: "/Всесвіт/Імперії/Федерація-Гетьманату/Зоряна-Справа/Кораблі/Сокіл"
---
...
The designers sacrificed armor thickness for maximum speed and acceleration. The lightweight hull of multi-layered composites can withstand only debris, micrometeorites, and light-weapons fire. The primary protection of the "Sokil" is not its armor, but its maneuverability, powerful main engines, and a system of attitude thrusters that allow instantaneous changes in direction without loss of speed.
...
The fire-control system is largely automated. The onboard computer predicts the target's trajectory, compensates for relative velocities, and controls the micro-corrections of the "[[Ship Weapons/Shylo-M Laser Installation|Shylo-M]]" emitters. The pilot's task is not so much precise aiming as choosing the optimal attack position.

The "Sokil" possesses an exceptional thrust-to-mass ratio, allowing it to accelerate faster than most ships of its class. At the same time, the fuel and reaction-mass reserves for the maneuvering thrusters limit the duration of autonomous operations. For this reason, interceptors usually operate from carriers, dreadnoughts, or orbital bases, where they can quickly replenish energy cells and reaction-mass reserves.
